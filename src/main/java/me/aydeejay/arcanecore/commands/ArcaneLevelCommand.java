...
public class ArcaneLevelCommand implements TabExecutor {
    ...
    private void openArcaneGui(Player player) {
        ArcaneMenuHolder holder = new ArcaneMenuHolder();
        Inventory gui = Bukkit.createInventory(holder, 27, ChatColor.DARK_PURPLE + "Arcane Status");
        ...
        startGuiCooldownUpdater(player, gui);
    }
    ...
    private void startGuiCooldownUpdater(Player player, Inventory gui) {
