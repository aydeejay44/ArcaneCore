...
public class TraderListener implements Listener {
    ...
    private void openTraderGui(Player player) {
        ...
        breezeMeta.setLore(List.of(
                ChatColor.GRAY + "Chance: " +
                        plugin.getConfig().getInt("trader-chances.breeze") + "%"
        ));
        ...
        frostMeta.setLore(List.of(
                ChatColor.GRAY + "Chance: " +
                        plugin.getConfig().getInt("trader-chances.frost") + "%"
        ));
        ...
        emberMeta.setLore(List.of(
                ChatColor.GRAY + "Chance: " +
                        plugin.getConfig().getInt("trader-chances.ember") + "%"
        ));
        ...
        luckMeta.setLore(List.of(
                ChatColor.GRAY + "Chance: " +
                        plugin.getConfig().getInt("trader-chances.luck") + "%"
        ));
    ...
    private void rollTrader(Player player) {
        int breezeChance = plugin.getConfig().getInt("trader-chances.breeze", 25);
        int frostChance = plugin.getConfig().getInt("trader-chances.frost", 25);
        int emberChance = plugin.getConfig().getInt("trader-chances.ember", 25);
        int luckChance = plugin.getConfig().getInt("trader-chances.luck", 25);
